...
<!--- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
	...
	ALTERAÇÕES RELEVANTES Incluem a TRADUÇÃO de alguns termos
	...
	<CFIF Caller.SR LT Caller.RecordsToDisplay>
		<CFELSE>
			...
			<cfif Attributes.UseBold IS "Yes"><B></cfif>
			 &##171; <A HREF="#Attributes.ThisPageName#?SR=#BackUp##Attributes.ExtraURL#"><FONT Face="#Attributes.DisplayFont#" SIZE="#Attributes.FontSize#">#Attributes.RecordsToDisplay# #Attributes.DisplayText#s Anteriores</FONT></A>
			<cfif Attributes.UseBold IS "Yes"></B></cfif>
		...
		<CFSET FORWARD = (Caller.SR + Caller.RecordsToDisplay)>
			<CFIF StartRowB GT Attributes.Records>
				...
				<CFIF StartRowA IS StartRowB>
					<cfif Attributes.UseBold IS "Yes"><B></cfif>
					<A HREF="#Attributes.ThisPageName#?SR=#Forward##Attributes.ExtraURL#">
					<NOBR><FONT Face="#Attributes.DisplayFont#" SIZE="#Attributes.FontSize#">Próximo #Attributes.DisplayText#</FONT></NOBR></A> &##187;
					<cfif Attributes.UseBold IS "Yes"></B></cfif>
				<CFELSE>
					<cfif Attributes.UseBold IS "Yes"><B></cfif>
					<A HREF="#Attributes.ThisPageName#?SR=#Forward##Attributes.ExtraURL#">
					<NOBR><FONT Face="#Attributes.DisplayFont#" SIZE="#Attributes.FontSize#">Próximos #LastRecords# #Attributes.DisplayText#s</FONT></NOBR></A> &##187;
					<cfif Attributes.UseBold IS "Yes"></B></cfif>
				</CFIF>
			<CFELSE>
				<cfif Attributes.UseBold IS "Yes"><B></cfif>
				<A HREF="#Attributes.ThisPageName#?SR=#Forward##Attributes.ExtraURL#">
				<FONT Face="#Attributes.DisplayFont#" SIZE="#Attributes.FontSize#"">Próximos #Attributes.RecordsToDisplay# #Attributes.DisplayText#s</FONT></A> &##187;
				<cfif Attributes.UseBold IS "Yes"></B></cfif>
			</CFIF>
	<CFELSE>
			<cfif Attributes.UseBold IS "Yes"><B></cfif>
			<FONT Face="Arial" Size="#Attributes.FontSize#""><!---		End of List		 ---></FONT>
			<cfif Attributes.UseBold IS "Yes"></B></cfif>
	</CFIF>
</cfif>
