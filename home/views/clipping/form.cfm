...
<form action="#buildURL('clipping.save')#" method="post" role="form" class="form-horizontal">
    ...
    <input type="hidden" name="clipping_id" id="clipping_id" value="#HtmlEditFormat(rc.clipping_id)#">

    <div class="form-group">
        <label for="clipping_titulo" class="control-label col-sm-2">Title <span class="required">*</span></label>
        <div class="col-sm-9">
            <input type="text" name="clipping_titulo" value="#HTMLEditFormat(rc.clipping_titulo)#" size="100"  class="form-control" >
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <textarea name="clipping_texto" id="clipping_texto" cols="50" rows="10" class="form-control" >#HTMLEditFormat(rc.clipping_texto)#</textarea>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="url" name="clipping_link" value="#HTMLEditFormat(rc.clipping_link)#" size="100"  class="form-control" >
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" name="clipping_fonte" value="#HTMLEditFormat(rc.clipping_fonte)#" size="100"  class="form-control" >
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" name="published" value="#dateFormat(rc.published, "dd/mm/yyyy")#" size="10"
